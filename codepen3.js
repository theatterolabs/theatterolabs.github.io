...
function hashtable_containsKey(key) {
    ...
    for (
        iCounter = 0; iCounter < this.hashtable.length; iCounter = iCounter + 1
    ) {
...
var d2 = new Date();
var timeString = "Time taken : " + (d2 - d1) + "ms";
var key = fp.get();
var seed = 0;
var uid = MurmurHash3.hashString (key, key.length, seed);

document.getElementById("tag").innerText = uid;
document.getElementById("time").innerText = timeString;

}

window.onload = initFingerprintJS;  
